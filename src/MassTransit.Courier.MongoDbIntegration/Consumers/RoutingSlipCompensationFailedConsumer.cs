...
namespace MassTransit.Courier.MongoDbIntegration.Consumers
{
    ...
    public class RoutingSlipCompensationFailedConsumer :
        Consumes<RoutingSlipCompensationFailed>.Context
    {
        readonly EventPersister _persister;

        public RoutingSlipCompensationFailedConsumer(EventPersister persister)
        {
            _persister = persister;
        }

        public void Consume(IConsumeContext<RoutingSlipCompensationFailed> context)
        {
